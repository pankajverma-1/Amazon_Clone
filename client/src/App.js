                ...
                <Nav className="me-auto  w-100  justify-content-end">
                  {islogin ? (
                    ...
                    >
                      ...
                      <NavDropdown.Item>
                        <Link to="/orderhistory" className="navlinks">
                          Order History
                        </Link>
                      </NavDropdown.Item>
                      <NavDropdown.Divider />
                  ...
                  {data.isAdmin ? (
                    ...
                    >
                      <NavDropdown.Item>
                        <Link to="/admin/dashboard" className="navlinks">
                          Dashboard
                        </Link>
                      </NavDropdown.Item>
                      <NavDropdown.Item>
                      ...
                      <NavDropdown.Item>
                        <Link to="/admin/allOrders" className="navlinks">
                          Orders
                        </Link>
                      </NavDropdown.Item>
                      <NavDropdown.Divider />
                      <NavDropdown.Item>
                        <Link to="/admin/allUser" className="navlinks">
                          Users
                        </Link>
                      </NavDropdown.Item>
                    </NavDropdown>
